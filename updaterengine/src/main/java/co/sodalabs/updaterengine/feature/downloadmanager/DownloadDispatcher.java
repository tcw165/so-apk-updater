...
class DownloadDispatcher extends Thread {
    ...
    private void executeDownload(DownloadRequest request, String downloadUrl) {
        ...
        try {
            ...
            Log.v("Response code obtained for downloaded Id " + request.getDownloadId() + " : httpResponse Code " + responseCode);
            ...
            switch (responseCode) {
                ...
                case HTTP_INTERNAL_ERROR:
                    ...
                    break;
                default:
                    updateDownloadFailed(request, DownloadManager.ERROR_UNHANDLED_HTTP_CODE,
                                         "Unhandled HTTP response:" + responseCode + " message:" + conn.getResponseMessage());
                    break;
            }
        ...
        try {
            ...
            if (!errorCreatingDestinationFile) {
                ...
                if (in == null) {
                    ...
                    updateDownloadFailed(request, DownloadManager.ERROR_FILE_ERROR, "Error in writing download contents to the destination file");
                } else {
    ...
    private void attemptRetryOnTimeOutException(final DownloadRequest request) {
        ...
        try {
            ...
            updateDownloadFailed(request, DownloadManager.ERROR_CONNECTION_TIMEOUT_AFTER_RETRIES, "Connection time out after maximum retires attempted");
        }
    }
